...
class GCPCloudStorage:
    ...
    def upload_image(
        ...
        try:
            # Construct the blob path: public/products/translated/description/{image_name}.webp
            blob_path = f"public/products/translated/description/{image_name}.webp"
    ...
    def process_and_upload_image(
        ...
        try:
            ...
            # Upload to GCS
            logger.info(f"Uploading image to GCS: public/products/translated/description/{image_name}.webp")
            blob_path = self.upload_image(webp_data, folder_name, image_name)
            if not blob_path:
